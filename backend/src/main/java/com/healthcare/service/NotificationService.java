...
public class NotificationService {
    ...
    public void sendAppointmentConfirmation(User patientUser, User doctorUser,
        ...
        String patientBody = buildEmail(EmailConfig.builder()
                ...
                .subheading("Hi " + firstName(patientName) + ", we've successfully scheduled your visit. Here are your details:")
                .rows(new String[][]{
    ...
    public void sendAppointmentRescheduled(User patientUser, User doctorUser,
        ...
        String patientBody = buildEmail(EmailConfig.builder()
                ...
                .subheading("Hi " + firstName(patientName) + ", your visit has been moved to the updated slot below.")
                .rows(new String[][]{
                        { ICON_PATIENT, "Patient", patientName },
                        { ICON_DOCTOR, "Doctor",  docPart },
        ...
        sendEmail(patientEmail, patientName, subject, patientBody, patientSlipPdf, "rescheduled-appointment-slip.pdf");
        sendEmail(doctorEmail, doctorName, subject, doctorBody, doctorSlipPdf, "rescheduled-appointment-slip.pdf");
    ...
    private String joinDateTime(String date, String time) {
        if (date == null || date.isBlank()) return time != null ? time : "";
        if (time == null || time.isBlank()) return date;
        return date + " at " + time;
    }
    ...
    public void sendCancellationNotification(User patientUser, User doctorUser,
        ...
        String patientBody = buildEmail(EmailConfig.builder()
                ...
                .rows(new String[][]{
                        ...
                        { ICON_DATE, "Was Scheduled", datePart },
        ...
        String doctorBody = buildEmail(EmailConfig.builder()
                ...
                .subheading("Hi Dr. " + firstName(doctorName) + ", this appointment is no longer on your schedule.")
                .rows(new String[][]{
                        { ICON_PATIENT, "Patient",       patientName },
                        { ICON_DATE, "Was Scheduled", datePart },
                        { ICON_PATIENT, "Cancelled By",  cancelledBy },
    ...
    public void sendAppointmentReminder(User patientUser, String appointmentDetails) {
        ...
        String body = buildEmail(EmailConfig.builder()
                ...
                .subheading("Hi " + firstName(name) + ", this is a friendly reminder about your upcoming visit.")
                .rows(new String[][]{
                        { ICON_DOCTOR, "Doctor",   docPart },
                        { ICON_DATE, "Date",     datePart },
                        { ICON_TIME, "Time",       timePart },
    ...
    public void sendPrescriptionNotification(User patientUser, String doctorName, byte[] prescriptionPdf) {
        ...
        String body = buildEmail(EmailConfig.builder()
                ...
                .subheading("Hi " + firstName(name) + ", your doctor has prepared a prescription after your consultation.")
                .rows(new String[][]{
    ...
    public void sendPaymentConfirmation(User patientUser, Double amount, byte[] updatedAppointmentSlipPdf) {
        ...
        String body = buildEmail(EmailConfig.builder()
                ...
                .subheading("Hi " + firstName(name) + ", we've successfully processed your payment. Here's your summary:")
                .rows(new String[][]{
    ...
    public void sendPayAtAppointmentNotification(User patientUser, User doctorUser,
        ...
        String patientBody = buildEmail(EmailConfig.builder()
                ...
                .rows(new String[][]{
                        { ICON_DOCTOR, "Doctor",     docPart },
                        { ICON_DATE, "Schedule",   schedulePart },
        ...
        String doctorBody = buildEmail(EmailConfig.builder()
                ...
                .heading("Patient will pay at appointment time")
                .subheading("Hi Dr. " + firstName(doctorName) + ", this patient has chosen to pay at the clinic.")
                .rows(new String[][]{
                        { ICON_PATIENT, "Patient",    patientName },
                        { ICON_DATE, "Schedule",   schedulePart },
                        { ICON_PAYMENT, "Amount Due", formattedAmount },
        ...
        sendEmail(patientEmail, patientName, "Pay At Appointment Time - MediCare",
                patientBody, appointmentSlipPdf, "appointment-slip.pdf");
        sendEmail(doctorEmail, doctorName, "Patient Will Pay At Appointment Time - MediCare",
    ...
    public void sendNoShowNotification(User patientUser, String appointmentDetails, String doctorName) {
        ...
        String body = buildEmail(EmailConfig.builder()
                ...
                .subheading("Hi " + firstName(name) + ", we noticed you were unable to attend your scheduled appointment. Your health matters to us.")
                .rows(new String[][]{
                        { ICON_DOCTOR, "Doctor",     "Dr. " + doctorName },
                        { ICON_DATE, "Was Scheduled", datePart },
    ...
    public void sendVerificationOtp(User user, String otp) {
        ...
        String body = buildEmail(EmailConfig.builder()
                ...
                .subheading("Hi " + firstName(user.getName()) + ", use the one-time code below to activate your MediCare account.")
                .otpCode(otp)
                .alertIcon(ICON_TIME)
    ...
    public void sendVerificationSuccessEmail(User user) {
        ...
        String body = buildEmail(EmailConfig.builder()
                ...
                .subheading("Hi " + firstName(user.getName()) + ", your email has been verified and your MediCare account is now fully active.")
                .rows(new String[][]{
    ...
    public void sendFollowUpReminder(User patientUser, String doctorName, String followUpDate) {
        ...
        String body = buildEmail(EmailConfig.builder()
                ...
                .subheading("Hi " + firstName(patientUser.getName()) + ", your follow-up with " + displayName + " is coming up soon.")
                .rows(new String[][]{
    ...
    private static class EmailConfig {
        ...
        static class Builder {
            ...
            Builder theme(String v)      { this.theme = v;      return this; }
            Builder icon(String v)       { this.icon = v;       return this; }
            Builder badge(String v)      { this.badge = v;      return this; }
            Builder heading(String v)    { this.heading = v;    return this; }
            Builder subheading(String v) { this.subheading = v; return this; }
            Builder rows(String[][] v)   { this.rows = v;       return this; }
            Builder otpCode(String v)    { this.otpCode = v;    return this; }
            Builder alertIcon(String v)  { this.alertIcon = v;  return this; }
            Builder alertText(String v)  { this.alertText = v;  return this; }
            Builder footerNote(String v) { this.footerNote = v; return this; }
            EmailConfig build()          { return new EmailConfig(this); }
        }
    }
    ...
    private String buildEmail(EmailConfig cfg) {
        ...
        sb.append("<!DOCTYPE html>")
          ...
          .append("<tr>")
          // Teal cross icon
          .append("<td style=\"background-color:").append(primary).append(";border-radius:12px;width:42px;height:42px;text-align:center;vertical-align:middle;\">")
          ...
          .append("<span style=\"font-size:24px;font-weight:700;color:").append(primary).append(";letter-spacing:-0.5px;\">Medi</span>")
        ...
        if (cfg.rows != null && cfg.rows.length > 0) {
            ...
            for (int i = 0; i < cfg.rows.length; i++) {
                ...
                sb.append("<tr>")
                  .append("<td class=\"row-table\" style=\"background-color:").append(rowBg)
                  .append(";").append(borderTop).append("padding:0;\">")
                  .append("<table role=\"presentation\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">")
                  .append("<tr>")
                  // Emoji indicator bar
                  .append("<td style=\"width:44px;background-color:").append(light).append(";text-align:center;")
                  .append("vertical-align:middle;padding:14px 0;\">")
                  .append("<span style=\"font-size:17px;\">").append(emoji).append("</span>")
                  .append("</td>")
                  // Label
        ...
        if (cfg.otpCode != null && !cfg.otpCode.isBlank()) {
            sb.append("<table role=\"presentation\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" style=\"margin-bottom:24px;\">")
              ...
              .append("<p style=\"margin:0 0 10px;font-size:11px;font-weight:600;letter-spacing:0.1em;text-transform:uppercase;color:").append(dark).append(";\">")
        ...
        if (cfg.alertText != null && !cfg.alertText.isBlank()) {
            sb.append("<table role=\"presentation\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" style=\"margin-bottom:8px;\">")
              .append("<tr>")
              .append("<td width=\"3\" style=\"background-color:").append(primary).append(";border-radius:3px 0 0 3px;\"></td>")
              .append("<td style=\"background-color:").append(light).append(";border-radius:0 10px 10px 0;padding:14px 16px;\">")
